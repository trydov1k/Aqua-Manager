    ...
    public class TutorialForm : Form
    {
        ...
        private readonly (string Title, string Text, string Emoji)[] _steps =
        {
            ("Добро пожаловать в Aqua Manager!",
             ...
             "Нажмите «Далее» или стрелку вправо, чтобы узнать, как играть.",
             "🐠"),
            ...
            ("Кормление рыбок",
             ...
             "• Кнопка «Режим кормления», а после клик на рыбку — кормит только одну рыбку.\n\n" +
            ...
            ("Чистота воды",
             ...
             "Если чистота упадет до 0, то все рыбки в аквариуме умрут\n\n" +
            ...
            ("Магазин",
             ...
             "Открыть магазин также можно при помощи пробела",
             "🏪"),
            ...
            ("Сохранение и меню",
             ...
             "• Загрузки сохранения\n" +
             "• Начала новой игры\n" +
             "• Прохождения обучения заново\n\n"/* + 
             "Игра также автоматически сохраняется каждые 5 минут."*/,
             "💾"),
            ("Горячие клавиши",
             "• Переключить аквариум: ← / → или A / D\n" +
             "• Поменять воду в аквариуме: F\n" +
             "• Покормить всех: Q\n" +
             "• Включить режим кормления: E\n" +
             "• Включить удаление рыбок: R \n"+
             "• Выбрать рыбку (для режима кормления и удаления): 1 - 6",
             "🔑"),

            ("Готово!",
             "Теперь вы знаете всё необходимое.\n" +
             "Удачи в управлении аквариумным бизнесом!\n\n" +
             "Помни, что рыбки голодают даже когда выбран другой аквариум\n" +
             "Посказка: пройти обучение еще раз можно по кнопке F1",
             "🎉"),
        };
